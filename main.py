...
for epoch_index in range(500):
    ...
    for train_img_index, train_img, train_gt, data_ptc in train_loader:
        ...
        if step % 100 == 0:
            ...
            if MAE > validate_MAE:
                MAE = validate_MAE
                torch.save(net, "/home/zzn/Downloads/CSRNet_pytorch-master/checkpoints/csrnet_mae_b.pkl")

            # save model
            if MSE > validate_RMSE:
                MSE = validate_RMSE
                torch.save(net, "/home/zzn/Downloads/CSRNet_pytorch-master/checkpoints/csrnet_mse_b.pkl")

            torch.save(net, "/home/zzn/Downloads/CSRNet_pytorch-master/checkpoints/csrnet_in_time.pkl")
